const groupingTrainingData = [
    ...
    // Tema: Administrativo/Operacional
    ...
    // Algumas tarefas "fora" dos grupos claros ou com múltiplos temas
    "Pesquisar ferramenta de monitoramento de servidor e apresentar para a equipe de back-end",
    "Discutir requisitos da nova feature de relatório de vendas com o time de front-end",
    "Revisar o código de autenticação e otimizar a rota de login",
    "Preparar conteúdo para o blog e analisar métricas de acesso para melhorar SEO",
    "Agendar reunião com o cliente para discutir o orçamento e o cronograma do projeto",
];
